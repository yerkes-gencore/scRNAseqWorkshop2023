...
DimPlot(obj, group.by = "RNA_snn_res.0.4", label = TRUE)
DimPlot(obj, group.by = "RNA_snn_res.0.6", label = TRUE)
DimPlot(obj, group.by = "RNA_snn_res.0.8", label = TRUE)
DimPlot(obj, group.by = "RNA_snn_res.1", label = TRUE)
DimPlot(obj, group.by = "RNA_snn_res.1.2", label = TRUE)
```
...
```{r}
label.canonical_markers <- vector(
  "0" = "enter_label_here",
...
Run SingleR
```{r}
singler_out <- SingleR(test = obj, ref = ref, labels = ref$label.main)
```
