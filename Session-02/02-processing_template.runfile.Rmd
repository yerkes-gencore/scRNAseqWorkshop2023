...
Recall that UMAP is a visualization technique to reduce high-dimensional data into lower space for plotting. We perform UMAP on the principle components.
...
in a capture. But ultimately the UMAP output is just that: coordinate values for plotting. 
...
clusters with no observable distinction. Resolution selection is often an iterative 
